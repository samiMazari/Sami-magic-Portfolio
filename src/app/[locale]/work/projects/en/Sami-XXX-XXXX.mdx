---
title: "Exploratory Data Analysis with SAS : TSA-Claims Dataset"
publishedAt: "2025-01-01"
summary: "prepare and analyze claims data from the Transportation Security Administration (TSA) with SAS Studio     
Link to the Case Study in Github : [TSA-Claims-SAS](https://github.com/samiMazari/TSA-Claims-SAS)   "
images:
